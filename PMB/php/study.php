...
<header>
    <form>
      ...
      <div class="form-group row">
            ...
            <div class="col-sm-8">
                <select class ="form-control" id="exampleInputinformasi1">
      ...
      <div class="form-group row">
            ...
            <div class="col-sm-8">
              ...
              <div class="col-sm-12 ">
              <a href="upload.php" class="btn btn-warning btn-sm float-right" tabindex="-1" role="button" aria-disabled="true">Lanjut>></a>
             <a href="datakeluarga.php" class="btn btn-danger btn-sm float-right" tabindex="-1" role="button" aria-disabled="true">>>Back</a>
