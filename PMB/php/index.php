        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">            
                <a href="daftar.php" class="nav-link btn-primary btn-sm btn-lg active" role="button" aria-pressed="true">Daftar Sekarang</a>
              </li>
            </ul>
          </div>
             ...
             <h3 class="title-galery-feed"> our galery</h3>
                ...
                <div class="row no-gutters">
                   <div class="col-md-4 col-sm-6 col-xs-6 item zoom-on-hover">
                    <a class="lightbox"href="#gambar1"><img  src="../image.web/foto2.id.png " weight=400px height="400px"></a>
                  <dir class="overlay" id="gambar1">
                    <img src="../image.web/foto2.id.png"alt="... "></img>
                 ...
                 <div class="col-md-4 col-sm-6 col-xs-6 item zoom-on-hover">
                    <a class="lightbox"href="#"><img  src="../image.web/foto2.id.png " weight=400px height="400px"></a>
               </div>
                   <div class="col-md-4 col-sm-6 col-xs-6 item zoom-on-hover">
                    <a class="lightbox"href="#"><img  src="../image.web/foto2.id.png " weight=400px height="400px"></a>
               </div>
               ...
               <div class= "button ml-auto">
                 <a href="galery.php"class="more-galery-feed " class="btn btn-primary my-2 my-sm-0"type="button" > Check Our Galery </a>
               </div> 
                 </div> 
                 </div> 
</section>
    ...
    <h2 class="lead"> Sekolah Tinggi Teknik Cendekia (SSTC) merupakah Salah satu perguruan tinggi swasta yang berada dikawasan islamic village kota Tangerang. 
      ...
      <div class="container py-5 mt-5">
        <div class="row align-items-center ">
          <div class="col-md-6 mb-5 mb-md-0">
            <div class="img-gradient img-gradient-right"><img class="img-fluid shadow rounded" src="../image.web/foto2.id.png" alt=".."></div> 
          </div>
        <div class="col-md-5 ">
            ...
            <form action="#">
              <div class="row">
                <div class="col-md-4 col-xs-4 text-center">
                  <div  style="width: ;" >
                   <img src="../image.web/lo3.png" class="card-img-top " alt="..." width="200">
                  <div class="card-body py-6 col-sm-5 col-md-5"> 
                  <h3 class=" card-text h4">Lokasi Kampus</h3>
                <ul class="list-unstyled sm-12">
                  <li class="text-muted text-center"><a class="reset-anchor" href="mailto:iso@company.com">jl. qadr.islamic village </a></li>
                ...
                <div class="col-md-4 col-xs-3 text-center">
                  <div  style="width:" >
                   <img src="../image.web/email1.jpg" class="card-img-top" alt="..."width="200">
                ...
                <div class="col-md-4 col-xs-3 text-center">
                  <div  style="" >
                   <img src="../image.web/38.png" class="card-img-top" alt="..."width="200">
